...
public class YahooFinanceProperties {
    ...
    private String quoteBatchPath = "/v7/finance/quote";
    ...
    public String getQuoteBatchPath() {
        return quoteBatchPath;
    }

    public void setQuoteBatchPath(String quoteBatchPath) {
        this.quoteBatchPath = quoteBatchPath;
    }
